...
<div class="related">
  ...
  <div class="actions">
    <ul class="nav nav-pills">
      <li class="active"><?php echo "<?php echo \$this->Html->link(__('New " . Inflector::humanize(Inflector::underscore($alias)) . "'), array('controller' => '{$details['controller']}', 'action' => 'add')); ?>"; ?> </li>
    </ul>
  </div>
</div>
<?php endforeach; ?>
